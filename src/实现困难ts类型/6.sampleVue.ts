...
function SimpleVue<
  DataReturns extends Record<string, any>,
  ComputedReturns extends Record<string, (this: DataReturns) => any>
>(template: {
  data: () => DataReturns;
  computed: ComputedReturns;
  methods: Record<
    string,
    (
      this: DataReturns & {
        [k in keyof ComputedReturns]: ReturnType<ComputedReturns[k]>;
      }
    ) => any
  >;
}) {
